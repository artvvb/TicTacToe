...
import_files -norecurse $src_dir/others/sprites.hex
set_property file_type {Data Files} [get_files  ./Tic-Tac-Toe.srcs/sources_1/imports/others/sprites.hex]
